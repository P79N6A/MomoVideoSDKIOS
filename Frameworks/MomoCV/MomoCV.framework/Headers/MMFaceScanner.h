...
typedef NS_ENUM(NSUInteger, MMFacePoseType) {
    MMFacePoseTypeNormal,
    MMFacePoseTypeSmallDegree,
    MMFacePoseTypeBigDegree,
};
...
@property (nonatomic, assign) BOOL saveFeature; //default Yes
